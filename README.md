...
Standalone lecture-plugin repo for **`grade-7.physics.si-units.3`**, deployed to the ed-tech
...
```
https://cdn.jsdelivr.net/gh/<owner>/plugin-grade-7-physics-si-units-3@v<version>/dist/index.js
```
