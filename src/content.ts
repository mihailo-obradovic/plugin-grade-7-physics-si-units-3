...
> = {
  ...
  "sr-latn": [
    ...
    {
      "prompt": "Pretvorite 5 kilometara u metre koristeći formulu: udaljenost (m) = udaljenost (km) × 1000.",
      "choices": [
        "500 m",
        "5000 m",
        "50.000 m",
    ...
    {
      "prompt": "Ako automobil pređe 120 metara za 6 sekundi, koja mu je brzina u metrima po sekundi? Koristite formulu: brzina = udaljenost ÷ vrijeme.",
      "choices": [
        "14 m/s",
        "20 m/s",
        "720 m/s",
  ...
  "sr-cyrl": [
    ...
    {
      "prompt": "Претворите 5 километара у метре користећи формулу: удаљеност (m) = удаљеност (km) × 1000.",
      "choices": [
        "500 m",
        "5000 m",
        "50.000 m",
    ...
    {
      "prompt": "Ако аутомобил пређе 120 метара за 6 секунди, која му је брзина у метрима по секунди? Користите формулу: брзина = удаљеност ÷ вријеме.",
      "choices": [
        "14 m/s",
        "20 m/s",
        "720 m/s",
